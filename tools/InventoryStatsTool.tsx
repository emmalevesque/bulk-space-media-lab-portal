...
const InventoryStatsToolComponent = () => {
  const totalInventoryCostQuery = groq`
  math::sum(*[_type == "item"][].replacementCost)`

  const { data: totalInventoryItemsCost } = useFetch(
    totalInventoryCostQuery
  ...
  *[_type == "item"][]{
  ...
  // const { data: totalActiveCategoriesData, error: totalActiveCategoriesError } =
        ...
        <Grid columns={2} gap={3}>
          ...
          >
            ...
            <p className="font-bold">
              <AnimatedNumber toValue={totalInventoryItemsCost} isCurrency />
            </p>
          </Button>
          <Button
            radius={3}
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <p className="font-bold">
                      <AnimatedNumber toValue={category.children} delay={2} />
                    </p>
                  </IntentLink>
                </Button>
              )
...
export default function InventoryStatsTool(): Tool {
  return {
    ...
    icon: BarChartIcon,
    component: InventoryStatsToolComponent,
  }
}
